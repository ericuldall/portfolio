...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", mergeProps({
  ...
  }), [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.value, function(item, index2) {
    return openBlock(), createElementBlock("div", mergeProps({
      key: $options.getKey(item, index2),
      "class": _ctx.cx("event")
    }, $options.getPTOptions("event", index2)), [createBaseVNode("div", mergeProps({
      "class": _ctx.cx("opposite", {
        index: index2
      })
    }, $options.getPTOptions("opposite", index2)), [renderSlot(_ctx.$slots, "opposite", {
      item,
      index: index2
    })], 16), createBaseVNode("div", mergeProps({
      "class": _ctx.cx("separator")
    }, $options.getPTOptions("separator", index2)), [renderSlot(_ctx.$slots, "marker", {
      item,
      index: index2
    }, function() {
    ...
    }), index2 !== _ctx.value.length - 1 ? renderSlot(_ctx.$slots, "connector", {
      key: 0,
      item,
      index: index2
    }, function() {
    ...
    }, $options.getPTOptions("content", index2)), [renderSlot(_ctx.$slots, "content", {
      item,
      index: index2
    })], 16)], 16);
  }), 128))], 16);
